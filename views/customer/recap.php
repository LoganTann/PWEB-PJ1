...
<main>
    ...
    <nav>
        <div class="nav-wrapper">
            <div class="col s3">
                <a class="breadcrumb">Panier</a>
                <a class="breadcrumb">Récapitulatif</a>
            </div>
        </div>
    </nav>
        ...
        <div class=card>
            ...
            <div class="card-content">
                ...
                <div class="info-container">
                    <p>
                        <?php echo('Vous avez reservé cette voiture du '.date('d/m/Y',strtotime($_SESSION['dates']['Debut'])).' au '.date('d/m/Y',strtotime($_SESSION['dates']['Fin']))) .'<br>';?>
                        <?php
                ...
                ?>
                <div class="info-container">
                    <svg class="icones" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="#191919" d="M11,13 L8,13 L8,18 L6,18 L6,6 L8,6 L8,11 L11,11 L11,6 L13,6 L13,11 L16,11 L16,6 L18,6 L18,13 L13,13 L13,18 L11,18 L11,13 Z M8,4 L6,4 L6,2 L8,2 L8,4 Z M12.9997,4.0001 L10.9997,4.0001 L10.9997,2.0001 L12.9997,2.0001 L12.9997,4.0001 Z M18,4 L16,4 L16,2 L18,2 L18,4 Z M12.9997,22.0001 L10.9997,22.0001 L10.9997,20.0001 L12.9997,20.0001 L12.9997,22.0001 Z M8,22 L6,22 L6,20 L8,20 L8,22 Z"></path></svg>
                    <?php
                ...
                <div class="info-container">
                    <svg class="icones" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M21,20V2H10v11H7c-0.6,0-1,0.5-1,1v3H4l0-7.6l4.7-4.7L7.3,3.3L2,8.6V13l0,5c0,0.5,0.4,1,1,1h4c0.5,0,1-0.5,1-1v-3h2v5H9v2   h13v-2H21z M19,10h-7V4h7V10z"></path></g></svg>
                    <?php
